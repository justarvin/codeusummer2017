...
public final class NetworkCode {
  ...
  public static final int
      ...
      NEW_CONVERSATION_INTEREST_REQUEST = 15,
      NEW_CONVERSATION_INTEREST_RESPONSE = 16,
      NEW_USER_INTEREST_REQUEST = 17,
      NEW_USER_INTEREST_RESPONSE = 18,
      GET_USER_INTEREST_REQUEST = 19,
      GET_USER_INTEREST_RESPONSE = 20,
      GET_CONVERSATIONS_INTEREST_REQUEST = 21,
      GET_CONVERSATIONS_INTEREST_RESPONSE = 22,
