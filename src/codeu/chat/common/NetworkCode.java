...
public final class NetworkCode {
  ...
  public static final int
      ...
      ADD_MEMBER_REQUEST = 65,
      ADD_MEMBER_RESPONSE = 66,
      REMOVE_MEMBER_REQUEST = 67,
      REMOVE_MEMBER_RESPONSE = 68,
      CHECK_MEMBER_REQUEST = 69,
      CHECK_MEMBER_RESPONSE = 70,
      CHECK_OWNER_REQUEST = 71,
      CHECK_OWNER_RESPONSE = 72;
}
